...
abrupt_time_threshold = 20
abrupt_value_threshold = 15
    ...
    def identify_stable_concepts(self, df):
        ...
        while i < df.shape[0] - 2 * self.base_window_size:
            ...
            while not stable_concept and i < df.shape[0] - 2 * self.drift_window_size:
                ...
                if abs(mean_so_far - min_mean) < drift_std and abs(mean_so_far - max_mean) < drift_std:
...
cdd = CDDetection()
concept_start_end = cdd.identify_stable_concepts(df)
